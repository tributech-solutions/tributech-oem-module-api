...
| ----------- | ----------- | ----------- | ----------- | ----------- | ----------- |
| API V1.0 | yes | yes | yes | yes | yes |
| API V1.1 | yes | yes | yes | yes | yes |
| API v1.2 | no | no | no | no | no |
...
This function parses and extractes the timestamp from the get_time command response and returns it in uint64_t
```C
